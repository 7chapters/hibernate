package info._7chapters.hibernate.hql;
 ...
 * @see info._7chapters.hibernate.hql.Employees
	...
	public Employees findById(int id) {
		...
		try {
			Employees instance = (Employees) sessionFactory.getCurrentSession()
					.get("info._7chapters.hibernate.hql.Employees", id);
			if (instance == null) {
	...
	public List findByExample(Employees instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("info._7chapters.hibernate.hql.Employees")
